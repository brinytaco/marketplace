...
use Dem\HelpDesk\Controller\Adminhtml\Department\Index as Controller;
...
/**
 * HelpDesk Unit Test - Controller Adminhtml Department Index
 *
 * =============================================================================
 *
 ...
 * @since      1.0.0
 */
class AdminControllerDepartmentIndexTest extends TestCase
{
    /**
     * @var ObjectManager
     */
    ...
    /**
     * @covers \Dem\HelpDesk\Controller\Adminhtml\Department\Index::execute()
     */
